<footer class="bg-slate-900 text-slate-300">
        <div class="container mx-auto px-4 py-12">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                <!-- Company Info -->
                <div>
                    <h3 class="text-white font-bold mb-4">TechStore</h3>
                    <p class="text-sm mb-4">Your trusted source for premium electronics and technology products.</p>
                    <div class="flex gap-3">
                        <a href="#" class="social-icon w-9 h-9 rounded-full bg-slate-800 flex items-center justify-center">
            ...
            <div class="pt-8 border-t border-slate-800 text-sm text-center">
